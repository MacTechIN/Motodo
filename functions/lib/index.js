...
exports.sendWeeklyReport = exports.updateMemberStats = exports.exportTeamToCSV = exports.aggregateTeamStats = exports.getAdminDashboardMetrics = exports.backupToSheets = void 0;
const https_1 = require("firebase-functions/v2/https");
const admin = require("firebase-admin");
const googleapis_1 = require("googleapis");
const json2csv_1 = require("json2csv");
admin.initializeApp();
exports.backupToSheets = (0, https_1.onCall)(async (request) => {
    var _a;
    if (!request.auth) {
    ...
    if (((_a = userDoc.data()) === null || _a === void 0 ? void 0 : _a.role) !== "admin") {
        throw new https_1.HttpsError("permission-denied", "Only admins can trigger backups.");
    }
    ...
    const values = [
        ...
        ...todos.map(t => {
            var _a;
            return [
                ((_a = t.createdAt) === null || _a === void 0 ? void 0 : _a.toDate().toISOString()) || "",
                t.content,
                t.priority,
                t.isSecret,
                t.isCompleted
 ...
 */
exports.getAdminDashboardMetrics = (0, https_1.onCall)(async (request) => {
    var _a, _b, _c;
    if (!request.auth) {
        throw new https_1.HttpsError("unauthenticated", "User must be logged in.");
    }
    ...
    const stats = ((_b = teamDoc.data()) === null || _b === void 0 ? void 0 : _b.stats) || { totalCompleted: 0, totalCount: 0 };
    ...
    const lastBackupAt = (_c = teamDoc.data()) === null || _c === void 0 ? void 0 : _c.lastBackupAt;
    let pendingCount = 0;
    if (lastBackupAt) {
 ...
 */
exports.aggregateTeamStats = firestore
 ...
 * Admin-only CSV Export
 */
exports.exportTeamToCSV = (0, https_1.onCall)(async (request) => {
    var _a;
    if (!request.auth) {
        throw new https_1.HttpsError("unauthenticated", "User must be logged in.");
    }
    ...
    const todos = snapshot.docs.map(doc => {
        ...
        const createdAt = (_a = d.createdAt) === null || _a === void 0 ? void 0 : _a.toDate();
        const completedAt = (_b = d.completedAt) === null || _b === void 0 ? void 0 : _b.toDate();
        ...
        return {
            userName: userMap[d.createdBy] || d.createdBy,
            content: content,
            priority: priorityText,
            duration: durationHours,
            privacy: privacyStatus,
            createdAt: (createdAt === null || createdAt === void 0 ? void 0 : createdAt.toISOString()) || "",
            completedAt: (completedAt === null || completedAt === void 0 ? void 0 : completedAt.toISOString()) || ""
        };
    });
    try {
        ...
        throw new https_1.HttpsError("internal", "CSV failure");
    }
});
/**
 ...
 */
exports.updateMemberStats = firestore
 ...
 */
exports.sendWeeklyReport = (0, https_1.onCall)(async (request) => {
